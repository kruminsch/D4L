...
int getting_ready(int ac, char **av)
{
    ...
    if (ac == 2 && av[1][0] == '-' && av[1][1] == 'h') {
	    ...
	    write(1, "make sure it consists of valid email addresses separated by a new line\n", 72);
	   write(1, "U could also run ./gen for creating a testing list of 1000000 entries\n", 70); 
	   exit(0);
    } 
    if (ac != 3) {
